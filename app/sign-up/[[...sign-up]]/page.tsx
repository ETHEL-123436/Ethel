      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center py-12 px-4">
        <div className="max-w-2xl w-full">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Join RideConnect</h1>
            <p className="text-gray-800 font-medium">Choose your role to get started</p>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-800 font-medium">Create your account to get started</p>
        </div>
        ...
        <Card>
          <CardContent className="p-6">
            <SignUp 
              ...
              afterSignUpUrl={`/onboarding?role=${selectedRole}`}
            />
          </CardContent>
        </Card>
      </div>
