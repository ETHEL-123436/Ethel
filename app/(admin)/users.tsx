...
import { Search, Filter, User, Shield, Ban, Trash2, Eye } from 'lucide-react-native';
import { useAdmin } from '@/providers/admin-provider';
import { User as UserType } from '@/types';

export default function AdminUsers() {
  const insets = useSafeAreaInsets();
  const { users, updateUserStatus, suspendUser, deleteUser } = useAdmin();
  ...
  const filteredUsers = users.filter(user => {
    ...
    const matchesKyc = selectedKycStatus === 'all' || user.kycStatus === selectedKycStatus;
